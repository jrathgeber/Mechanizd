...
with open("F:/Numerai/numerai502/v4.1/features.json", "r") as f:
...
training_data = pd.read_parquet('F:/Numerai/numerai502/v4.1/train.parquet', columns=read_columns)
validation_data = pd.read_parquet('F:/Numerai/numerai502/v4.1/validation.parquet', columns=read_columns)
