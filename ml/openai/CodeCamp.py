...
def post_creator(sourceURL, wpBaseURL, sourceLang, targetLang, postStatus):
    ...
    auth = HTTPBasicAuth('python_blog_poster', 'ZEMB MAIR N3sb UGvX CRPF qTuP')
...
post_creator("https://jsonplaceholder.typicode.com/posts/5", "https://www.trifindr.com/", "la", "en", "publish")
