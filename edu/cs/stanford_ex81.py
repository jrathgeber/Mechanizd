...
data1 = loadmat('F:\ML\machine-learning-ex8\machine-learning-ex8\ex8\ex8data1.mat')
data1.keys()
...
ax1.vlines(threshold, 0, 0.9, colors='r', linestyles='dotted', label='Threshold for {} percentile = {}'.format(percentile, np.round(threshold, 2)))
