...
def fileReading(location, location1, link):
    ...
    for item in thelist:
        ...
        if (timestr in item ):
            myFile.write('<tr><td>\n')
            myFile.write(item[40:43].replace('/','').replace('_',''))
            myFile.write('</td>\n')

            myFile.write('<td>\n')
            myFile.write('<a href=./'+item[20:43]+'_'+timestr+'.txt>'+item[40:43]+'_'+ timestr +'.txt</a>')
            myFile.write('</td>\n')
            ...
            myFile.write('<td>\n')
            myFile.write('<a href=./'+item[20:43]+'_'+timestr+'_testtrades.csv>'+item[40:43] +'_'+ timestr +'_testtrades.csv</a>')
            myFile.write('</td>\n')

            myFile.write('<td>\n')
            myFile.write('<a href=./'+item[20:43]+'_'+timestr+'.htm>'+item[40:43]+'_'+ timestr +'.htm</a>')
            myFile.write('</td>\n')
            ...
            myFile.write('<td>\n')
            myFile.write('<a href=./'+item[20:43]+'_'+timestr+'_pnl.csv>'+item[40:43]+'_'+ timestr +'_pnl.csv</a>')
            myFile.write('</td>\n')
